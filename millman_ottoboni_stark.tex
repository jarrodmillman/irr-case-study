...
data by typing the following three commands from a shell prompt:
\begin{verbatim}
...
reproducibility, applied statisticians have embraced version control
...
including version control.\footnote{For
example, see:
