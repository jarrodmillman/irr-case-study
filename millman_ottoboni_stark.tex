...
In this case study, \emph{reproducibility} means that we (JM, KO, PS)
documented (and scripted) nearly every step of the analysis---from cleaning to coding to
...
We (JM, KO, PS) had recently begun to develope a general purpose Python package
